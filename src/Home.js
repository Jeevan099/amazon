    ...
    <div className='home'>
        <div className='home_container'>
            ...
            <div className='home_row' >
                <Product 
                id="12321341"
                title='The Lean Startup: How Constant Innovation Creates Radically Succeccful Businesses Paperback' 
                price={29.99} 
                ...
                price={1}
                rating={4}
                image="https://www.boat-lifestyle.com/cdn/shop/files/Artboard2_32_1500x.png?v=1689917312"/>
